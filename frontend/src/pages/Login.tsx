  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-indigo-500/10 dark:bg-indigo-500/5 rounded-full blur-3xl animate-pulse-soft" />
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-purple-500/10 dark:bg-purple-500/5 rounded-full blur-3xl animate-pulse-soft" style={{ animationDelay: '1s' }} />
      </div>
      ...
      <div className="w-full max-w-md relative animate-scale-in">
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl dark:shadow-2xl dark:shadow-slate-900/50 border border-slate-200/50 dark:border-slate-700/50 p-8 backdrop-blur-sm">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Войдите в свой аккаунт FinTrack</p>
          </div>
